...
Task: Create a user form using text, email, password, radio, and checkbox inputs.
...
Task: Build a webpage using internal & external CSS, applying colors, margins, and positioning.
...
Task: Create a calculator layout using CSS Grid, gradients & box shadows.
...
Task: Animate an element diagonally using transition + transform properties.
...
Task: Build a responsive card UI (image, title, text) with hover transitions.
...
Task: Build a responsive portfolio using Bootstrap grid & utilities.
...
Task: Build a responsive portfolio with Carousel and Progress Bar to showcase skills.
